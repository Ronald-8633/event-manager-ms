...
public class DescriptionValidationRule implements PublishingValidationRule {
    ...
    public String validate(Event event) {
        if (event.getDescription() == null || event.getDescription().trim().isEmpty()) {
            throw new BusinessException(messageService.getMessage(EM_0011, event.getDescription()));
        }
        return null;
    }
}
