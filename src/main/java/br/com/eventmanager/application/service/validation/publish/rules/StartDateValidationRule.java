...
public class StartDateValidationRule implements PublishingValidationRule {
    ...
    public String validate(Event event) {
        if (event.getStartDate() == null) {
            throw new BusinessException(messageService.getMessage(EM_0011, event.getStartDate().toString()));
        }
        return null;
    }
}
